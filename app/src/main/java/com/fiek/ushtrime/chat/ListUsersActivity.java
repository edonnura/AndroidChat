    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCreateChat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int counChoice=lstUsers.getCount();
    ...
    private void createGroupChat(SparseBooleanArray checkedItemPositions) {
        ...
        QBRestChatService.createChatDialog(dialog).performAsync(new QBEntityCallback<QBChatDialog>() {
            ...
            public void onSuccess(QBChatDialog qbChatDialog, Bundle bundle) {
               mDialog.dismiss();
                Toast.makeText(getBaseContext(),"Dialog chat created successfully!",Toast.LENGTH_SHORT).show();
    ...
    private void retrieveAllUser() {
        QBUsers.getUsers(null).performAsync(new QBEntityCallback<ArrayList<QBUser>>() {
            ...
            public void onSuccess(ArrayList<QBUser> qbUsers, Bundle bundle) {
                ...
                ArrayList<QBUser> qbUserWithoutCurren=new ArrayList<QBUser>();
                for (QBUser user:qbUsers){
                    if (!user.getLogin().equals(QBChatService.getInstance().getUser().getLogin())){
                        qbUserWithoutCurren.add(user);
                    }
                }

                ListUserAdapter adapter=new ListUserAdapter(getBaseContext(),qbUserWithoutCurren);
